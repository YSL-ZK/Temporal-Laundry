...
export default function OpenGraphImage() {
  return new ImageResponse(
    <div style={{ position: "relative", display: "flex", width: "100%", height: "100%", alignItems: "center", overflow: "hidden", padding: "72px 84px", background: "#071117", color: "#f1f7f5" }}>
      ...
      <div style={{ position: "absolute", right: 185, top: 175, display: "flex", width: 170, height: 170, alignItems: "center", justifyContent: "center", borderRadius: "52px", background: "#b8f5d2", color: "#09291d", fontSize: 112, fontWeight: 800 }}>L</div>
